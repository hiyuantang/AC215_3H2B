...
# Define all functions available to the travel expert
travel_expert_tool = Tool(function_declarations=[get_book_by_author_func,get_book_by_search_content_func])
